...
function sliderConent(pag, slider, spanPag) {
    pag.innerHTML = '';
...
sliderConent(pag, slider, spanPag)
...
sliderTestimonials(pagTest, sliderTest, spanPagTest)
function sliderTestimonials(pagTest, sliderTest, spanPagTest) {
